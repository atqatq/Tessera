...
**https://github.com/atqatq/Tessera/security/advisories/new** (private by
default, encrypted in transit). Please include affected component
(`kernel.*` service or module code), a repro or conformance vector, and impact
assessment. Do not open public issues for vulnerabilities.
