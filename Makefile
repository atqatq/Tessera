...
.PHONY: help setup toolchain test python-test lint fmt clippy coverage mutation docs vectors clean check
...
setup: toolchain
	...
	@echo "setup complete: cargo $(shell cargo --version 2>/dev/null || echo MISSING)"
