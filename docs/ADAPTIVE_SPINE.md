...
The hub's setup superpower: the system is industry- and niche-agnostic, and
...
The adaptive spine is the same class of hub capability as roles, accounts,
...
2. **Flows** — how things move (which SCOR anchors are active; which
   spokes are installed; hand-offs between them)
...
and extension spokes. A pharma tenant adds cold-chain probes and
quarantine dispositions; a two-person shop disables eight spokes and runs
