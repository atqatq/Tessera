...
| Code | Spoke | Echelon | Agent tier | Craft (agent line) | Industry-standard depth | IoT telemetry |
|---|---|---|---|---|---|---|
...
| `tsk` | TASKS | ext | advise | PRIORITIZES WORK | push target of every spoke + leader - SLAs - escalation curves - evidence | shop-floor badges, wearable pings |
